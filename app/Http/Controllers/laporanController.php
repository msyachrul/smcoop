...
class laporanController extends Controller
{
    ...
    {    	
        ...
        {
            $anggota = 'Semua';
            $penjualan = Penjualan::whereBetween('tanggal',[$tanggal['dari'],$tanggal['sampai']])->get();
        ...
        else
        {
            ...
            $penjualan = Penjualan::whereBetween('tanggal',[$tanggal['dari'],$tanggal['sampai']])->where('anggota_no',$request->anggota_no)->get();
